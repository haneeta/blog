...
* 感谢评论区 `jqgsninimo` [提供的改进](/posts/89dad1c1/#5c23395f1579a3005f18ede7)，方法更佳简单明了，本文已经更新该方法。 
* CSS 自定义文件指 `/source/_data/styles.styl`
* 本文基于 Hexo 3.9.0 / NexT 7.3.0

## 1. 下载图标
首先，前往 [阿里巴巴矢量库](http://www.iconfont.cn/) 挑选需要的图标，在图标上点击 <i class="fa fa-fw fa-shopping-cart"></i> 加入购物车。<!-- more -->
{% img /cloud/posts/2018/0613/pic_1.png 500 阿里巴巴矢量库 %}

然后，点击页面右上方 <i class="fa fa-fw fa-shopping-cart"></i> 进入购物车，选择「下载代码」。
{% img /cloud/posts/2018/0613/pic_2.png 300 购物车下载代码 %}
